                ...
                <div className=" w-[70%]  flex-box flex-col gap-8 items-start">
                        ...
                        <div className=" w-full flex-box justify-start flex-wrap gap-2">
                            {
                                ...
                                slotData.map(slotData=>{
                                    return <Button 
                                    value={slotData._id}
                                    onClick={e=>{setSlotType({slotID:e.target.value,slotType:slotData.type})}}
                                    text={slotData.type}
                                    className={slotType?.slotID == slotData._id ? " bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-violet-400 via-violet-600 to-sky-600 text-white" : ""} 
                                    />
...

                    {
                        ...
                        <div className=" flex-box flex-col gap-3 items-start">
                            ...
                            <div className=" w-full flex-box justify-start flex-wrap gap-2">
                                {slotData.filter(e=>e._id == slotType?.slotID).map((e) => {
                                    return e.availableSlot[parseInt(day.day)]?.map(e2=>{
                                        return (
                                            <SlotType
                                                key={e2}
                                                value={e2}
                    ...
                    <GradientLink url={`/payment/${stationData._id}`} state={{stationData,day,time,slotType }} text={"Proceed to Pay"} />
                    </div>
                </div>
            </div>
