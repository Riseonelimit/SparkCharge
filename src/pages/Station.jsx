  ...
  return (
    <section className=' w-full h-[100vh] flex-box flex-col justify-evenly  bg-[#f8f1ff]'>
            ...
            <div className=' w-[70%]  flex-box flex-col gap-8 items-start'>
                <div className=' flex-box flex-col gap-3 items-start'>
                    ...
                    <div className=' inline-flex'>
                        <button className=' border-2  border-r-0 border-violet-500 px-3 py-2 rounded-s-lg  text-md font-bold hover:bg-violet-500 duration-300'>28 Dec</button>
                        <button className=' border-2 border-violet-500 px-3 py-2  text-md font-bold hover:bg-violet-500 duration-300'>29 Dec</button>
                        <button className=' border-2 border-l-0 border-violet-500 px-3 py-2 rounded-e-lg  text-md font-bold hover:bg-violet-500 duration-300'>30 Dec</button>
                    </div>
        ...
        <div className='  w-3/4 h-[30%] flex-box gap-3 mt-10 justify-start'>
            <div className=' p-5  justify-between h-full rounded-xl bg-[conic-gradient(at_right,_var(--tw-gradient-stops))] from-purple-300 to-violet-200 flex-box gap-10 shadow-md'>
                <div className=' h-full flex-box flex-col gap-3  items-start '>
                    <h1 className=' text-5xl font-bold'>Baka Station</h1>
                ...
                <div className=' p-10 h-full flex-box rounded-2xl bg-violet-400 bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-violet-400 via-violet-600 to-indigo-400 '>
